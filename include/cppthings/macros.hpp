...
#define _CPPTHINGS_FE_C_2(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_1(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_3(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_2(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_4(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_3(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_5(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_4(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_6(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_5(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_7(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_6(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_8(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_7(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_9(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_8(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_A(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_9(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_B(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_A(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_C(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_B(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_D(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_C(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_E(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_D(ACTION, __VA_ARGS__)
#define _CPPTHINGS_FE_C_F(ACTION, X, ...)  ACTION(X), _CPPTHINGS_FE_E(ACTION, __VA_ARGS__)
...
#define CPPTHINGS_FOR_EACH_COMMA(action, sep, ...) \
  _CPPTHINGS_GET_MACRO(_0 __VA_OPT__(,) __VA_ARGS__, \
