...
#define CPPTHINGS_EZ_CONSTRUCTOR(NAME, ...) \
  NAME(CPPTHINGS_FOR_EACH_COMMA(_CPPTHINGS_MAKE_PARAMS __VA_OPT__(,) __VA_ARGS__)) : CPPTHINGS_FOR_EACH_COMMA(_CPPTHINGS_MAKE_CONSTRUCTOR __VA_OPT__(,) __VA_ARGS__) {}
#else
#define CPPTHINGS_EZ_CONSTRUCTOR(NAME, ...) \
